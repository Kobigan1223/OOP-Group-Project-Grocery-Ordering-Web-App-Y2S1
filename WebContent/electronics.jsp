			...
			<div class="ele-bottom-grid">
				...
				<%
					ResultSet retriveProduct = DatabaseConnection
						.getResultFromSqlQuery("select * from tblproduct where product_category='Grocery'");
						...
						<div class="men-pro-item simpleCart_shelfItem">
							<div class="men-thumb-item">
								<input type="hidden" name="productId"
									...
									src="D:/Work-place/Grocery Ordering/WebContent/uploads/<%=retriveProduct.getString("image_name")%>"
		...
		<div class="container">
			<ul>
				...
				<li><span class="glyphicon glyphicon-envelope"
					aria-hidden="true"></span><a href="mailto:info@example.com">grocery@lk.com</a></li>
			</ul>
		</div>
	</div>
